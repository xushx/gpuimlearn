...
# Name : AdaBoost.M1
#
# Purpose : AdaBoost.M1 is an classification algorithm for multi-imbalanced data, which applies the focal loss in Boosting method.
#
...
class AdaBoostM1(object):
    ...
    def create_classifer(self, index=0):
        ...
        # return TGBMClassifier(n_trees = 5)
