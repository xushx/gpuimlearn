...
# Name : AdaBoost.M1
#
# Purpose : AdaBoost.M1 is an classification algorithm for multi-imbalanced data.
# 
...
class AdaBoostM1:
    ...
    def run(self, x_train, x_test, y_train, y_test, n_rounds):

        start_time = time.time()

        self.num_rounds = n_rounds
        self.train(x_train, y_train)
        pre_label = (self.predict(x_test)).reshape(-1, 1)
        ...
        return pre_label, acc, g_mean, f1_score, cost
